 ...
 *
 */
public class HighestNumberOfTweetsPerHour {
	...
	public static void main(String[] args) throws Exception {
		...
		Map<String, Integer> highestTweetsPerHour = new HashMap<String, Integer>();
		...
		try {
			while ((str = br.readLine()) != null) {
				...
				if (highestTweetsPerHour.containsKey(date[0] + " " + date[2]
						+ " " + hour))
					highestTweetsPerHour.put(
							date[0] + " " + date[2] + " " + hour,
							highestTweetsPerHour.get(date[0] + " " + date[2]
									+ " " + hour) + 1);
				else
					highestTweetsPerHour.put(date[0] + " " + date[2] + " "
							+ hour, 1);

			}
			System.out.println(highestTweetsPerHour);
			Thread.sleep(100);

			Map<String, Integer> sortedhighestTweetsPerHour = sortByValues(highestTweetsPerHour);
			for (Entry<String, Integer> entry : sortedhighestTweetsPerHour
					.entrySet()) {
